                                    ...
                                    <div class="page-records"  >
                                        <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"
                                            ...
                                            <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                                ...
                                                <Column  field="sender_user_id" :header="$t('senderUserId')" >
                                                    <template #body="{ data, index }">
                                                        <Button class="p-button-text" icon="pi pi-eye" :label="$t('users')" v-if="data.sender_user_id" @click="app.openPageDialog({ page: 'users/view', url: `/users/view/${data.sender_user_id}` , closeBtn: true })" />
                                                    </template>
                                                </Column>
