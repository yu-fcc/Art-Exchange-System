            ...
            <section class="page-section mb-3" >
                <div class="container-fluid">
                    <div class="grid justify-content-between align-items-center">
                        ...
                        <div  class="col-fixed " >
                            <template v-if="auth.canView('reputationhistory/add')">
                                ...
                                <template v-if="showFooter && pageReady">
                                    <div class="grid justify-content-between align-items-center">
                                        <div class="flex gap-2 flex-grow-0">
                                            <template v-if="auth.canView('reputationhistory')">
...
<script setup>
	...
	function getActionMenuModel(data){
		return [
		{
			...
			icon: "pi pi-eye",
			visible: auth.canView('reputationhistory/view')
		},
		{
			label: () => $t('edit'),
			to: `/reputationhistory/edit/${data.history_id}`,
			icon: "pi pi-pencil",
			visible: auth.canView('reputationhistory/edit')
		},
		{
			label: () => $t('delete'),
			command: (event) => { deleteItem(data.history_id) },
			icon: "pi pi-trash",
			visible: auth.canView('reputationhistory/delete')
		}
	]
	}
