                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <div class="mb-3">
                                                        <Uploader @uploadError="(msg)=>app.flashMsg('File Upload', msg, 'error')" :class="getErrorClass('file_hash')" upload-path="fileuploader/upload/file_hash" v-model="formData.file_hash" :fileLimit="1" :maxFileSize="5000000" accept=".docx,.doc,.xls,.xlsx,.xml,.csv,.pdf,.xps" :multiple="false" :label="$t('chooseFilesOrDropFilesHere')" />
                                                    </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'othercontentsadd',
		},
		apiPath : {
			type : String,
			default : 'othercontents/add',
		},
		submitButtonLabel: {
			type: String,
			default: () => $t('submit'),
	...
	onMounted(()=>{
		const pageTitle = $t('addNewOtherContent');
