...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'reportsreplyview',
		},
		apiPath: {
			type: String,
			default: 'reportsreply/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: () => $t('edit'),
			command: (event) => { app.openPageDialog({ page:'reportsreply/edit', url: `/reportsreply/edit/${data.reply_id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = $t('reportsReplyDetails');
