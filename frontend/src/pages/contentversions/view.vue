        ...
        <template v-if="pageReady">
            <template v-if="showHeader">
                <section class="page-section mb-3" >
                    <div class="container">
                        <div class="text-2xl font-medium py-3"><div class="button-container">
                            <!-- 输入框 -->
                            <input 
                            type="text" 
                            v-model="versionId" 
                            ...
                            <div >
                                <div class="mb-3 grid ">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                ...
                                                <div class="font-bold">{{ item.year_created }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                    ...
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('contagnameId') }}</div>
                                                <div class="font-bold">{{ item.contagname_id }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('contagnameTitle') }}</div>
                                                <div class="font-bold">{{ item.contagname_title }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
                                        <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                            <div class="">
                                                <div class="text-400 mb-1">{{ $t('contagnameTagId') }}</div>
                                                <div class="font-bold">{{ item.contagname_tag_id }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 md:col-4">
