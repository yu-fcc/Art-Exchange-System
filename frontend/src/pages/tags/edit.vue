                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrltag_id" v-model.trim="formData.tag_id"  :label="$t('tagId')" type="number" :placeholder="$t('enterTagId')"   step="any"    
                                                    class=" w-full" :class="getErrorClass('tag_id')">
                                                    </InputText>
