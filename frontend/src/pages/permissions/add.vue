                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrlpermission" v-model.trim="formData.permission"  :label="$t('permission')" type="text" :placeholder="$t('enterPermission')"      
                                            ...
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <api-data-source :enable-cache="true"   api-path="components_data/role_id_option_list" >
                                                        <template v-slot="req">
                                                            <Dropdown  class="w-full" :class="getErrorClass('role_id')"   :loading="req.loading"   optionLabel="label" optionValue="value" ref="ctrlrole_id"  v-model="formData.role_id" :options="req.response" :label="$t('roleId')"  :placeholder="$t('selectAValue')" >
                                                            </Dropdown> 
...
<script setup>
	...
	onMounted(()=>{
		const pageTitle = $t('addNewPermission');
