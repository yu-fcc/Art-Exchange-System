            ...
            <section class="page-section mb-3" >
                <div class="container-fluid">
                    <div class="grid justify-content-between align-items-center">
                        ...
                        <div  class="col-fixed " >
                            <template v-if="auth.canView('messages/add')">
...
<script setup>
	...
	const props = defineProps({
		...
		pageStoreKey: {
			type: String,
			default: 'MESSAGES-MESSAGE_NOTIFICATION',
		},
		pageName: {
			type: String,
			default : 'messages',
		...
		routeName: {
			type: String,
			default: 'messagesmessage_notification',
		},
		apiPath: {
			type: String,
			default: 'messages/message_notification',
	...
	function getActionMenuModel(data){
		return [
		{
			...
			icon: "pi pi-eye",
			visible: auth.canView('messages/view')
		},
		{
			label: () => $t('edit'),
			to: `/messages/edit/${data.message_id}`,
			icon: "pi pi-pencil",
			visible: auth.canManage('messages/edit', data.receiver_id)
		},
		{
			label: () => $t('delete'),
			command: (event) => { deleteItem(data.message_id) },
			icon: "pi pi-trash",
			visible: auth.canManage('messages/delete', data.receiver_id)
		}
	]
	}
