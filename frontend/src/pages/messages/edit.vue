                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <div class="mb-3">
                                                        <Uploader :class="getErrorClass('ipfs_hash')" :auto="true" :fileLimit="1" :maxFileSize="3000000" accept=".mp3,.mp4,.webm,.wav,.avi,.mpg,.mpeg" :multiple="false" style="width:100%" :label="$t('chooseFilesOrDropFilesHere')" upload-path="fileuploader/upload/ipfs_hash" v-model="formData.ipfs_hash"></Uploader>
                                                    </div>
...
<script setup>
	...
	const formDefaultValues = Object.assign({
		sender_id: "", encrypted_content: "", ipfs_hash: "", status: "", 
	}, props.pageData);
