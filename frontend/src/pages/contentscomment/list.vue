                        ...
                        <div >
                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"
                                     :value="records" dataKey="comment_id" @sort="onSort($event)" class=" p-datatable-sm" :stripedRows ="true" :showGridlines="false" :rowHover="true" responsiveLayout="stack">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'contentscommentlist',
		},
		apiPath: {
			type: String,
			default: 'contentscomment/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
