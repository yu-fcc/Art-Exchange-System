            ...
            <section class="page-section mb-3" >
                <div class="container-fluid">
                    <div class="grid justify-content-between align-items-center">
                        ...
                        <div  class="col-fixed " >
                            <template v-if="auth.canView('contentcategories/add')">
                                ...
                                <template v-if="showFooter && pageReady">
                                    <div class="grid justify-content-between align-items-center">
                                        <div class="flex gap-2 flex-grow-0">
                                            <template v-if="auth.canView('contentcategories')">
...
<script setup>
	...
	function getActionMenuModel(data){
		return [
		{
			...
			icon: "pi pi-eye",
			visible: auth.canView('contentcategories/view')
		},
		{
			label: () => $t('edit'),
			to: `/contentcategories/edit/${data.category_id}`,
			icon: "pi pi-pencil",
			visible: auth.canView('contentcategories/edit')
		},
		{
			label: () => $t('delete'),
			command: (event) => { deleteItem(data.category_id) },
			icon: "pi pi-trash",
			visible: auth.canView('contentcategories/delete')
		}
	]
	}
